  ...
  return (
    <div className="site-shell">
      ...
      <aside className="left-rail" aria-label="知识库目录">
        ...
        <div className="rail-group"><p>00 · 数学与记号规范</p><a className="selected" href="/foundations/tensor-notation">向量、矩阵与 Token 轴</a><span className="rail-subhead">概率、采样与估计</span><a href="/foundations/importance-sampling">Importance Sampling</a></div>
